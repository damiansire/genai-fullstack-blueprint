...
var toolName = workerData.toolName, args = workerData.args;
function execute() {
            ...
            try {
                ...
                switch (toolName) {
                    case 'calculate_fibonacci':
                        n = args.n || 30;
                        fib_1 = function (num) { return num <= 1 ? num : fib_1(num - 1) + fib_1(num - 2); };
                        result = fib_1(n);
                        break;
                    case 'render_chart':
                        ...
                        break;
                    default:
                        result = { error: "Tool ".concat(toolName, " not recognized") };
                }
