...
@Component({
  ...
  imports: [FormField, ModelResponse, FileUpload],
  ...
  examples = [
    {
      ...
      prompt:
        'A photorealistic close-up portrait of an elderly Japanese ceramicist with deep wrinkles and a warm smile, inspecting a freshly glazed tea bowl in his rustic workshop. Soft golden hour light streaming through a window, 85mm portrait lens with bokeh.',
    },
    {
      category: 'Illustration',
      prompt:
        'A kawaii-style sticker of a happy red panda wearing a tiny bamboo hat, munching on a green bamboo leaf. Bold clean outlines, cel-shading, vibrant colors. White background.',
    },
    {
      category: 'Product',
      prompt:
        'A high-resolution studio-lit photograph of a minimalist ceramic coffee mug in matte black on polished concrete. Three-point softbox lighting, 45-degree angle, ultra-realistic with steam rising.',
    },
    {
      category: 'Logo',
      prompt:
        'Create a modern minimalist logo for a coffee shop called "The Daily Grind". Clean bold sans-serif font with a stylized coffee bean icon. Black and white color scheme.',
    },
    {
      category: 'Comic',
      prompt:
        'A gritty noir comic panel with high-contrast black and white. Detective in trench coat under flickering streetlamp in rain. Neon bar sign reflecting in puddle. Caption box: "The city keeps no secrets."',
    },
  ];
